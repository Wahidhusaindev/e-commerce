        ...
        <div className="text-center max-w-md mx-auto px-4">
          <div className="bg-red-50 border border-red-200 rounded-2xl p-8 mb-6">
            ...
            <p className="text-gray-600 mb-6">
              {error ||
                "We're having trouble loading our products right now. Please try again later."}
            </p>
            <button
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Discover our handpicked selection of top-rated products loved by
                our customers
              </p>
            </div>
            <Carousel
      ...
      <section className="py-16 px-4 bg-linear-to-br from-gray-300 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Explore our full range of high-quality products, carefully curated
              for your needs
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {products.map((product) => (
              <div
                key={product.id}
                className="bg-gray-100 rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden border border-gray-400 transition-all duration-500 hover:-translate-y-3 group"
              >
                <Link
                  to={`/product/${product.id}`}
