  ...
  if (wishlistItems.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-8 text-center">
        ...
        <p className="text-gray-600 mb-8">Add some products to your wishlist to keep track of items you like!</p>
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm">{item.rating.rate} ({item.rating.count})</span>
                </div>
              </div>
